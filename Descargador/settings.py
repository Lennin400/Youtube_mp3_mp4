...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-c=2dy*iw)2jffa3apzw#k@1@f6q3+550*%b2v^1065%xr6n11^')

# SECURITY WARNING: don't run with debug turned on in production!
# 🚀 CAMBIADO: Detecta automáticamente si está en producción
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

# 🚀 CAMBIADO: Hosts permitidos para producción
ALLOWED_HOSTS = []

if RENDER:
    # En Render, permitir el host de Render + locales
...
# 🚀 STATIC FILES PARA PRODUCCIÓN (AGREGAR AL FINAL)
...
#Esto es para guardar los archivos descargados
MEDIA_ROOT = os.path.join(BASE_DIR, 'downloads')
MEDIA_URL = 'media/'  # 🚀 AGREGADO (opcional, pero recomendado)